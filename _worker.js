...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-e67.pages.dev/ip.txt?token=1',
	// 'https://cf-workers-text2kv-e67.pages.dev/ip.txt?token=CY123456', //可参考内容格式 自行搭建。
...
let DLS = 6;//速度下限
let addressescsv = [
	'https://cf-workers-text2kv-e67.pages.dev/cs.csv?token=CY123456', //iptest测速结果文件。
];
